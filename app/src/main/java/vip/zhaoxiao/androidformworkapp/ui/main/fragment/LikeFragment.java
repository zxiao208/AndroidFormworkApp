...
import vip.zhaoxiao.androidformworkapp.base.contract.main.LikeContract;
import vip.zhaoxiao.androidformworkapp.model.bean.RealmLikeBean;
import vip.zhaoxiao.androidformworkapp.presenter.main.LikePresenter;
import vip.zhaoxiao.androidformworkapp.ui.main.adapter.LikeAdapter;
import vip.zhaoxiao.androidformworkapp.utils.SnackbarUtil;
import vip.zhaoxiao.androidformworkapp.widget.DefaultItemTouchHelpCallback;
...
public class LikeFragment extends BaseFragment<LikePresenter> implements LikeContract.View {
    ...
    protected void initEventAndData() {
        Log.i("LikeFragment", "initEventAndData: 执行了");
        mList = new ArrayList<>();
